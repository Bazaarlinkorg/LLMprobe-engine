...
export { scoreBiasFingerprint, scoreV3HDistributionFingerprint, shouldPromoteSubModelFromV3H, shouldFillSubModelFromV3G, filterFreshBiasBaselines, V3H_ACTIVE_PROMPT_POLICIES, policyForCandidates, selectBiasProbesForCandidates, candidateSiblingsFor, candidateSiblingsForFamily, candidateSiblingsForConfirmedFamily, biasDisplayName, sampleBiasFingerprint, sampleV3HDistributionFingerprint, } from "./sub-model-v3g-bias-fingerprint.js";
export type { BiasBaseline, BaselineFreshnessOpts, BiasObservation, V3GResult, V3HPolicy, V3HResult, } from "./sub-model-v3g-bias-fingerprint.js";
