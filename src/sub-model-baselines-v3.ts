...
export const V3_BASELINES: SubmodelBaselineV3[] = [
  ...
  // Generated by scripts/build-baseline-expansion-v4.mjs against OpenRouter.
  {
    ...
    capability: { q1_strawberry: "3", q2_1000days: "tuesday", q3_apples: "6", q4_prime: "541", q5_backwards: "etadommocca" },
    refusal: {
      // Curly apostrophe ''' (U+2019) — matches GPT-5 family convention
  ...
  // Generated by scripts/build-baseline-expansion-v5.mjs to fix prod probe
  // reports marking gpt-5.4-mini as "無法識別" — model exists on OpenRouter and
  // in the V1 ProbeBaseline DB, but was missing from V3 baselines.
  {
    modelId: "openai/gpt-5.4-mini",
    family: "openai",
    displayName: "GPT-5.4 Mini",
    cutoff: "2024-06",
    // q1_strawberry = "2" is a real model quirk (wrong answer, unique to 5.4-mini
    // among GPT-5 siblings — used to disambiguate from 5.3-codex/5-mini).
  ...
  // ── Expansion (iter6, 2026-05-10) ────────────────────────────────────────
  // Generated by scripts/build-baseline-expansion-v6.mjs against OpenRouter.
  // gpt-5.5 (released 2026-04-23 per OR id `openai/gpt-5.5-20260423`) was
  // missing from V3 baseline — V3 Global misclassified honest gpt-5.5 users
  // as the closest sibling. Adds the gap.
  // Note: openai/gpt-5.3 (non-codex) is NOT a valid OR model ID, so no baseline.
  {
